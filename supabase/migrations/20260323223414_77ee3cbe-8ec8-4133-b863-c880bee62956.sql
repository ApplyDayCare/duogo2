...
BEGIN
  ...
  -- Send in-app notifications for mutual matches with link
  IF _new_status = 'mutual' THEN
    ...
    VALUES
      (_user_id, 'It''s a match! 🎉 You and ' || _other_name || ' both accepted. Check your match reveal!', '/match-reveal/' || _match_id::text),
